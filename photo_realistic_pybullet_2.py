...
fruit_box = "fruit_box"
scale_fruit_box = random.uniform(0.1,0.2)
...
def adding_mesh_object(
    ...
    box_height = 0.2*(10*scale_fruit_box) #20 cm
    box_width  = (0.35 - 0.10)*(10*scale_fruit_box)
    box_length = (0.45 - 0.10)*(10*scale_fruit_box)
    
    toy_transform.set_position(visii.vec3(box_position[0]+random.uniform(-box_length/2,box_length/2),box_position[1]+random.uniform(-box_width/2,box_width/2),box_position[2]+0.08*scale_fruit_box))
...
#     basePosition = [0,0,box_height+0.1],
# )
